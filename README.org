...
These are some [[https://guix.gnu.org/][Guix]] examples for the usage of [[https://nonsmooth.gricad-pages.univ-grenoble-alpes.fr/siconos/index][Siconos]] through the [[https://hpc.guix.info/][Guix HPC]] channel.

* Usage

See [[https://guix.gnu.org/manual/en/html_node/Channels.html][Guix channels]] for more information about how to configure channels for guix.
